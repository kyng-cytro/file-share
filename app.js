...
app.post('/download', async (req, res) => {
    ...
    try{
        ...
        if(fileInfo.password == null){
            ...
            await fsPromise.writeFile(`${__dirname}/cache/${fileInfo.originalName}`, data.Body);
            return res.download(`${__dirname}/cache/${fileInfo.originalName}`,fileInfo.originalName)
        }
        else{
